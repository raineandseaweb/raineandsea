...
export function ProductCardSkeleton() {
  return (
    <div className="bg-card rounded-2xl shadow-sm border border-border/50 p-6 animate-pulse">
      <div className="bg-muted rounded-lg h-48 w-full mb-4"></div>
      <div className="bg-muted rounded-lg h-4 w-full mb-2"></div>
      <div className="bg-muted rounded-lg h-4 w-3/4 mb-4"></div>
      <div className="bg-muted rounded-lg h-8 w-full"></div>
    </div>
  );
}
...
export function CategoryCardSkeleton() {
  return (
    <div className="bg-card rounded-2xl shadow-sm border border-border/50 overflow-hidden animate-pulse">
